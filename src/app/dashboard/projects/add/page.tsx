  ...
  return (
    <div className="bg-slate-50/50 min-h-screen p-4 md:p-6 lg:p-8 space-y-6">
      <div className="flex items-center gap-3 border-b border-slate-100 pb-5">
        ...
        <div>
          <h1 className="text-2xl font-black text-[#001f3f]">Add New Project</h1>
          <p className="text-sm text-slate-400">Build a premium showcase card for your client portfolio.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.02)] space-y-4">
            ...
            {/* Slug */}
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Slug (Optional)</label>
              <input
                type="text"
                placeholder="e.g. shoppingcart-bd"
                {...register("slug")}
                className="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#001f3f] focus:border-[#001f3f] text-slate-700 font-medium text-sm"
              />
              <p className="text-[10px] text-slate-400">If left empty, slug will be auto-generated from project title.</p>
            </div>
