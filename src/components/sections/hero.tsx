  ...
  "
              ...
              <motion.div className="flex items-center gap-5 text-slate-400 dark:text-slate-500 pt-1" variants={itemVariants}>
                {settings?.socialLinks?.github && (
                  <a href={settings.socialLinks.github} target="_blank" rel="noopener noreferrer" className="hover:text-[#FF7849] transition-colors">
                ...
                {settings?.socialLinks?.linkedin && (
                  <a href={settings.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-[#FF7849] transition-colors">
